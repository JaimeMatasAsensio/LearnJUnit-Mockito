...
public class IntegracionJpaTest {
    ...
    void testCreate() {
        ...
        assertTrue(cuenta.isPresent());
        assertEquals(new BigDecimal("1500"), cuenta.orElseThrow().getSaldo());
    }
    ...
    void testUpdate() {
        ...
        assertEquals("Antonio",cuenta.orElseThrow().getPersona());
        assertEquals(new BigDecimal("500"),cuenta.orElseThrow().getSaldo());
    }
